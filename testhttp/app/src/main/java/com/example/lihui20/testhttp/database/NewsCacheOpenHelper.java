 ...
 */
public class NewsCacheOpenHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "news_cache.db";
    public static final String DATABASE_TABLE = "newscache_table";
    ...
    public NewsCacheOpenHelper(Context context) {
